...
class safe_auto_nonlinear_car(safe_auto_nonlinear):
    def __init__(self, func_f, func_A, func_g, func_C, x0, u0, y0, interval, std, T, ADM, EM, u_type, devID, RFM="DeadReck"):
	super(safe_auto_nonlinear_car, self).__init__(func_f, func_A, func_g, func_C, x0, u0, y0, interval, std, T, ADM, EM, u_type, devID, RFM="DeadReck") # brings everything over from parent class
